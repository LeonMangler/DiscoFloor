...
public class Cuboid implements Iterable<Block>, Cloneable,
	...
	public Cuboid expand(CuboidDirection dir, int amount) {
		...
		case East:
			return new Cuboid(this.worldName, this.x1, this.y1, this.z1
					- amount, this.x2, this.y2, this.z2);
		case West:
			return new Cuboid(this.worldName, this.x1, this.y1, this.z1,
	...
	public Cuboid outset(CuboidDirection dir, int amount) {
		...
		case Horizontal:
			...
			break;
		case Vertical:
			c = expand(CuboidDirection.Down, amount).expand(CuboidDirection.Up,
					amount);
			break;
		case Both:
	...
	public Block getRelativeBlock(int x, int y, int z) {
		return this.getWorld()
				.getBlockAt(this.x1 + x, this.y1 + y, this.z1 + z);
	}
	...
	public Iterator<Block> iterator() {
		return new CuboidIterator(this.getWorld(), this.x1, this.y1, this.z1,
				this.x2, this.y2, this.z2);
	}
	...
	public class CuboidIterator implements Iterator<Block> {
		...
		public Block next() {
			Block b = this.w.getBlockAt(this.baseX + this.x, this.baseY
					+ this.y, this.baseZ + this.z);
			if (++x >= this.sizeX) {
				this.x = 0;
